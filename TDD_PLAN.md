...
|| net/ | ~1,200 | 15 | ~20% | 2 | ✅ 纯函数已覆盖 |
|| busybox/ | ~1,500 | 10 | ~15% | 2 | ✅ 纯函数已覆盖 |
|| cloudhost/ | ~800 | 5 | ~10% | 2 | ✅ 基础测试完成 |
|| install/ | ~200 | 13 | ~40% | 2 | ✅ 包管理器路由已覆盖 |
|| upgrade/ | ~500 | 5 | ~15% | 2 | ✅ 纯函数已覆盖 |
|| ping/ | ~300 | 1 | ~5% | 2 | ✅ 常量测试(ICMP需集成测试) |
