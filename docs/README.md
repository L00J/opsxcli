...
| 03 | [Harness 工程化与反馈回路](03-Harness工程化与反馈回路.md) | Harness 理论、前馈/反馈、Steering Loop |
| 04 | [插件架构设计](04-插件架构设计.md) | 插件分类、注册机制、扩展规范 |
| 05 | [Builtin 内置命令](05-Builtin内置命令.md) | 基础命令 Go 原生实现策略 |
| 06 | [Agent 核心引擎设计](06-Agent核心引擎设计.md) | ReAct 主循环、自适应检查点、16 轮迭代 |
| 07 | [Prompt 构建与记忆注入](07-Prompt构建与记忆注入.md) | 五层 System Prompt + 动态记忆层 |
| 08 | [Evolver 自进化引擎](08-Evolver自进化引擎.md) | 经验学习、三层记忆、自我进化 |
| 09 | [安全系统与工具注册](09-安全系统与工具注册.md) | 风险评估、三级安全模式、Tool 接口扩展 |
| 10 | [会话管理](10-会话管理.md) | JSONL 持久化、会话恢复 |
| 11 | [TUI 终端界面设计](11-TUI终端界面设计.md) | Bubble Tea 界面、Agent 交互 |
