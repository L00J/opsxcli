...
| 03 | [插件架构设计](03-插件架构设计.md) | 插件分类、注册机制、扩展规范 |
| 04 | [Builtin 内置命令](04-Builtin内置命令.md) | 基础命令 Go 原生实现策略 |
| 05 | [Agent 核心引擎设计](05-Agent核心引擎设计.md) | ReAct 主循环、自适应检查点、16 轮迭代 |
| 06 | [Prompt 构建与记忆注入](06-Prompt构建与记忆注入.md) | 五层 System Prompt + 动态记忆层 |
| 07 | [Evolver 自进化引擎](07-Evolver自进化引擎.md) | 经验学习、三层记忆、自我进化 |
| 08 | [安全系统与工具注册](08-安全系统与工具注册.md) | 风险评估、三级安全模式、Tool 接口扩展 |
| 09 | [会话管理](09-会话管理.md) | JSONL 持久化、会话恢复 |
| 10 | [TUI 终端界面设计](10-TUI终端界面设计.md) | Bubble Tea 界面、Agent 交互 |
| 11 | [Agent 工程化与反馈回路](11-Agent工程化与反馈回路.md) | Harness 理论、前馈/反馈、Steering Loop |
