...
func NewCpCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Cp(args[0], args[1], recursive)
		},
	}
...
func NewMvCmd() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Mv(args[0], args[1])
		},
	}
}
...
func NewRmCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Rm(args, recursive, force)
		},
	}
...
func NewMkdirCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:  cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Mkdir(args, parents, 0755)
		},
	}
...
func NewRmdirCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:  cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Rmdir(args, parents)
		},
	}
...
示例:
  ...
  opsxcli chmod -R 644 /path/to/dir`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			mode := args[0]
			paths := args[1:]
			return builtin.Chmod(mode, paths, recursive)
		},
	}
...
示例:
  ...
  opsxcli chown -R 0:0 /path/to/dir`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			owner := args[0]
			paths := args[1:]
			return builtin.Chown(owner, paths, recursive)
		},
	}
...
示例:
  ...
  opsxcli ln -s /path/to/file symlink     # 创建符号链接`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			target := args[0]
			link := args[1]
			return builtin.Ln(target, link, symbolic)
		},
	}
...
func NewCatCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Cat(args, showLineNumbers)
		},
	}
