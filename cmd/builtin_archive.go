...
func NewUnzipCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:  cobra.MinimumNArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			return builtin.Unzip(args, opts)
		},
	}
